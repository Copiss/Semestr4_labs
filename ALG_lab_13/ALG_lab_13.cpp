...
#include <set>
#include <map>
//Функция displaced вычисляет таблицу смещений для алгоритма Бойера-Мура-Хорспула (BMH)
//Мы смотрим на шаблон и анализируем его , сопоставляя каждому символу его смещение от конца шаблона
...
//Проходим по тексту с конца к началу и сравниваем символы шаблона с соответствующими символами текста
//Если совпадение не найдено,используем отображение смещений, чтобы переместиться вправо по тексту

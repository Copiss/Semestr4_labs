...
//Функция для поиска шаблона в тексте
...
int main() 
{
    std::string text = "ababcababcabcabc"; //Наш замечательный текст, в котором ищем шаблон
    std::string pattern = "abcabc"; //Шаблон, который ищем
